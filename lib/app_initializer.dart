...
class AppInitializer {
  ...
  static Future<void> initializeGoogleSignIn({
    ...
    if (!kIsWeb && defaultTargetPlatform == TargetPlatform.android && (serverClientId == null || serverClientId.isEmpty)) {
      throw Exception('Google Sign-In misconfigured: serverClientId (Web client ID) is required on Android.');
    }
