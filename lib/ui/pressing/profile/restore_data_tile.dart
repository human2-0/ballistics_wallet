...
class _RestoreDataTileState extends ConsumerState<RestoreDataTile> {
    ...
    return showDialog<bool>(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          actions: <Widget>[
            TextButton(
              onPressed: () => Navigator.of(context).pop(false),  // This will close the dialog and return false
              child: const Text('Cancel'),
            ),
            TextButton(
              onPressed: () {
                Navigator.of(context).pop(true);  // This will close the dialog and return true
              },
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      title: const Text('Restore with backup'),
      onTap: () async {
