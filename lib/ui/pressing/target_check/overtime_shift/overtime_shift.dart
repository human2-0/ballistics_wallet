...
class OvertimeShiftCard extends ConsumerState<OvertimeShift>
  ...
  Widget build(BuildContext context) {
    ...
    final productImageSize = math.min(screenWidth * 0.52, screenWidth * 0.55);
    final weightBadgeWidth = math.min(screenWidth * 0.32, 150).toDouble();
