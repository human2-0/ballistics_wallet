                ...
                children: [
                  ...
                  _StatChip(
                    ...
                    value:
                        maxEntry == null
                            ? 'n/a'
                            : '${maxEntry.label} (£${formatDouble(maxEntry.value)})',
                  ),
                  _StatChip(
...
String _shortDayLabel(DateTime date) => '${date.day}/${date.month}';
...
class _BonusChart extends StatelessWidget {
  const _BonusChart({required this.entries, required this.maxValue});
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final naturalWidth =
            entries.isEmpty ? pointSpacing : entries.length * pointSpacing;
        final chartWidth =
            availableWidth < 0
                ? naturalWidth
        ...
        return Row(
          ...
          children: [
            SizedBox(
              ...
              child: Column(
                children: [
                  _AxisLabel(maxValue.toStringAsFixed(0)),
                  const Spacer(),
                  _AxisLabel((maxValue * 2 / 3).toStringAsFixed(0)),
                  const Spacer(),
                  _AxisLabel((maxValue / 3).toStringAsFixed(0)),
                  const Spacer(),
                  const _AxisLabel('0'),
                ],
              ),
