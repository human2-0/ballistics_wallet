...
void main() {
  BonusInfo buildBonus({
    ...
    return BonusInfo(
      ...
      isOvertime: false,
      produced: [
        Produced(productName: productName, amount: 1, ratio: 1),
      ],
    );
  }
  ...
  group('BonusInfoNotifier.getProductHistory', () {
    test('matches product names case- and whitespace-insensitively', () async {
      ...
      final entries = [
        buildBonus(productName: 'Widget', date: DateTime(2024, 1, 1)),
    ...
    test('excludes entries for other products', () async {
      ...
      final widgetEntry =
          buildBonus(productName: 'Widget', date: DateTime(2024, 2, 1));
      final otherEntry =
          buildBonus(productName: 'Gadget', date: DateTime(2024, 2, 2));
    ...
    test('returns empty history for empty product name', () async {
      ...
      await notifier.addBonusInfo(
        buildBonus(productName: 'Widget', date: DateTime(2024, 3, 1)),
      );
