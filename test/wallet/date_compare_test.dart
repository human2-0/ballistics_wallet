...
void main() {
  group('DateCompare extension', () {
    test('treats same calendar day as inclusive when checking before or same', () {
    ...
    test('treats same calendar day as inclusive when checking after or same', () {
    ...
    test('excludes values outside the calendar day window', () {
      final end = DateTime(2024, 7, 31);
      final occurrence = DateTime(2024, 8, 1);
