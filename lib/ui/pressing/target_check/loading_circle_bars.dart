...
class RainbowCircularProgressIndicatorState
  ...
  void initState() {
    ...
    unawaited(_colorRotationController.repeat());
...
class _RainbowCirclePainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(covariant _RainbowCirclePainter oldDelegate) =>
...
class MinimumCircleState extends State<MinimumCircle>
...
class _MinimumCirclePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas
      ..drawCircle(circleStartOffset, strokeWidthHalf, roundPaint)
      ..drawCircle(circleEndOffset, strokeWidthHalf, roundPaint);
  }

  @override
  bool shouldRepaint(covariant _MinimumCirclePainter oldDelegate) =>
