...
Future<String> saveToWallet({
  ...
  ref
      ...
      .updateRatio(productName, target, amount, workingHours, allowance);
  final targetRatio = ref.read(bonusInfoListProvider).ratio;
  final bonus =
      ref.read(bonusCalculator(targetRatio)) *
    ...
    while (true) {
      try {
        await ref
            ...
            .backupData(); // non-interactive repo call
        return;
      } catch (e) {
