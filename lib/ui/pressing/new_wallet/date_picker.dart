...
class DatePickerCalendarState extends ConsumerState {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
     await ref.read(bonusInfoListProvider.notifier).loadBonusInfos().catchError(debugPrint);
    });
  }
        ...
        CalendarDatePicker2(
          config: CalendarDatePicker2Config(
            ...
            dayBuilder: ({
              ...
              final dailyBonusInfo = bonusInfoList.where(
              ...
              const selectedPrimaryColor = Colors.blue; // Change this color as needed
