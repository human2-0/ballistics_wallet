...
Future<void> showProductNoteDialog(BuildContext context, WidgetRef ref) async {
  ...
  await showModalBottomSheet<void>(
    ...
    builder: (ctx) {
      return _ProductNoteSheet(product: product);
    },
  );
}
...
class _ProductNoteSheetState extends ConsumerState<_ProductNoteSheet> {
  ...
  Widget build(BuildContext context) {
    final history = ref
        ...
        .getProductHistory(widget.product.productName);
            ...
            children: [
              ...
              Text(
                widget.product.productName.isEmpty
                    ? 'Product note'
                    : '${widget.product.productName} note',
                ...
                _DescriptionToolbar(
                  onInsert: (s) {
                    ...
                    if (!sel.isValid) {
                      ...
                      final newText =
                          _controller.text.replaceRange(sel.start, sel.end, s);
                  ...
                  if (_isEditing)
                    ElevatedButton(
                      onPressed: () async {
                        ...
                        final updated =
                            widget.product.copyWith(description: _controller.text);
